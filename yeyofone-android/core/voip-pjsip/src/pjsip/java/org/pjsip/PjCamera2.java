...
public class PjCamera2
{
    ...
    // The application permission boundary owns the CAMERA runtime grant. This helper already
    // contains the SecurityException and returns a native-compatible error code when revoked.
